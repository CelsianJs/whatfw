// Package data — 49 confirmed + 1 partial + 4 investigating + 36 expected
export const pkgs = [
  // State Management
  ...
  // Content & Utilities
  { n: 'React Icons', d: '5M', c: 'Utilities', s: 'pass', t: 'All icon packs (FA, MD, etc.)' },
  ...
  { n: 'usehooks-ts', d: '2.6M', c: 'Utilities', s: 'pass', t: 'useLocalStorage, useDebounce' },
  ...
  // Under Investigation
  { n: 'Recharts', d: '13.8M', c: 'Charts', s: 'investigating', t: 'Render loop under investigation' },
  { n: 'React Select', d: '5.1M', c: 'Forms', s: 'investigating', t: 'Internal errors under investigation' },
  { n: 'React DatePicker', d: '2.7M', c: 'Forms', s: 'investigating', t: 'Class inheritance issue' },
  { n: 'AG Grid', d: '665K', c: 'Tables', s: 'investigating', t: 'Portal system conflict' },

  // Expected Compatible
  { n: 'clsx', d: '17.1M', c: 'Utilities', s: 'expected', t: 'Pure utility — no React dependency' },
  { n: 'classnames', d: '13M', c: 'Utilities', s: 'expected', t: 'Pure utility — no React dependency' },
  { n: 'lucide-react', d: '5.2M', c: 'Utilities', s: 'expected', t: 'SVG icon components via createElement' },
  { n: 'react-error-boundary', d: '4.8M', c: 'Utilities', s: 'expected', t: 'ErrorBoundary component' },
  { n: 'react-intersection-observer', d: '3.2M', c: 'Utilities', s: 'expected', t: 'Hooks-only IntersectionObserver' },
  { n: '@heroicons/react', d: '2.1M', c: 'Utilities', s: 'expected', t: 'SVG icon components' },
  { n: '@radix-ui/react-icons', d: '2M', c: 'Utilities', s: 'expected', t: 'SVG icons from Radix' },
  { n: '@phosphor-icons/react', d: '500K', c: 'Utilities', s: 'expected', t: 'Flexible icon system' },
  { n: 'valtio', d: '546K', c: 'State Management', s: 'expected', t: 'Proxy state with hooks' },
  { n: 'react-chartjs-2', d: '2M', c: 'Charts', s: 'expected', t: 'Chart.js wrapper components' },
  ...
  { n: 'react-beautiful-dnd', d: '3M', c: 'Drag & Drop', s: 'expected', t: 'Atlassian drag-and-drop' },
  { n: 'downshift', d: '1.5M', c: 'UI Components', s: 'expected', t: 'Accessible combobox primitive' },
  { n: 'react-modal', d: '1.3M', c: 'UI Components', s: 'expected', t: 'Accessible modal dialog' },
  { n: 'react-tabs', d: '900K', c: 'UI Components', s: 'expected', t: 'Accessible tabs component' },
  { n: 'react-paginate', d: '800K', c: 'UI Components', s: 'expected', t: 'Pagination component' },
  { n: 'react-slick', d: '1.2M', c: 'UI Components', s: 'expected', t: 'Carousel/slider component' },
  { n: 'react-virtuoso', d: '650K', c: 'Tables', s: 'expected', t: 'Virtualized list component' },
  { n: 'react-pdf', d: '1.5M', c: 'Utilities', s: 'expected', t: 'PDF document viewer' },
  { n: '@tanstack/react-router', d: '1M', c: 'Routing', s: 'expected', t: 'Type-safe TanStack router' },
  { n: '@tanstack/react-form', d: '300K', c: 'Forms', s: 'expected', t: 'Headless form management' },
  { n: 'react-hotkeys-hook', d: '1.7M', c: 'Utilities', s: 'expected', t: 'Keyboard shortcuts hook' },
  { n: 'use-debounce', d: '1.5M', c: 'Utilities', s: 'expected', t: 'Debounce/throttle hooks' },
  { n: 'react-responsive', d: '1.2M', c: 'Utilities', s: 'expected', t: 'Media query hooks' },
  { n: '@uidotdev/usehooks', d: '800K', c: 'Utilities', s: 'expected', t: 'Community hooks collection' },
  { n: 'react-loading-skeleton', d: '1M', c: 'UI Components', s: 'expected', t: 'Skeleton loading screens' },
  { n: 'react-spinners', d: '800K', c: 'UI Components', s: 'expected', t: 'Loading spinner components' },
  { n: 'react-textarea-autosize', d: '1.5M', c: 'Forms', s: 'expected', t: 'Auto-resizing textarea' },
  { n: 'react-scroll', d: '800K', c: 'Utilities', s: 'expected', t: 'Smooth scroll components' },
  { n: 'react-countup', d: '350K', c: 'Animation', s: 'expected', t: 'Animated number counter' },
  { n: 'react-fast-marquee', d: '500K', c: 'Animation', s: 'expected', t: 'Marquee/ticker animation' },
  { n: 'react-type-animation', d: '400K', c: 'Animation', s: 'expected', t: 'Typewriter text effect' },
  { n: 'react-confetti', d: '300K', c: 'Animation', s: 'expected', t: 'Confetti particle animation' },
  ...
  { n: 'react-qr-code', d: '300K', c: 'Utilities', s: 'expected', t: 'QR code generator' },
];
...
export const REPOS = {
  ...
  '@radix-ui/react-dialog': 'radix-ui/primitives', 'antd': 'ant-design/ant-design',
