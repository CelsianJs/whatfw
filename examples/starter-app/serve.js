...
function transformImports(code) {
  return code
    .replace(/from ['"]what-framework['"]/g, `from '/vendor/what-core.js'`)
    .replace(/from ['"]what-framework\/router['"]/g, `from '/vendor/what-router.js'`)
    .replace(/from ['"]what-core['"]/g, `from '/vendor/what-core.js'`)
    .replace(/from ['"]what-router['"]/g, `from '/vendor/what-router.js'`);
}
